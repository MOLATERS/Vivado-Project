...
#
# Script generated by Vivado on Fri Sep 01 13:48:03 +0800 2023
...
#
# Usage        : ramb.sh
#                ramb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ramb.sh [-reset_run]
#                ramb.sh [-reset_log]
#                ramb.sh [-help]
#
...
# script info
echo -e "ramb.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ramb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ramb xil_defaultlib.ramb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ramb -key {Behavioral:sim_1:Functional:ramb} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="I:/VA/Vivado/2023.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ramb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ramb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ramb.sh [-help]\n\
Usage: ramb.sh [-step]\n\
Usage: ramb.sh [-lib_map_path]\n\
Usage: ramb.sh [-reset_run]\n\
Usage: ramb.sh [-reset_log]\n\
Usage: ramb.sh [-keep_index]\n\
Usage: ramb.sh [-noclean_files]\n\n\
