...
#
# Script generated by Vivado on Fri Sep 01 09:46:03 +0800 2023
...
#
# Usage        : ramd.sh
#                ramd.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ramd.sh [-reset_run]
#                ramd.sh [-reset_log]
#                ramd.sh [-help]
#
...
# script info
echo -e "ramd.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ramd.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ramd xil_defaultlib.ramd xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ramd -key {Behavioral:sim_1:Functional:ramd} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ramd.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ramd.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ramd.sh [-help]\n\
Usage: ramd.sh [-step]\n\
Usage: ramd.sh [-lib_map_path]\n\
Usage: ramd.sh [-reset_run]\n\
Usage: ramd.sh [-reset_log]\n\
Usage: ramd.sh [-keep_index]\n\
Usage: ramd.sh [-noclean_files]\n\n\
